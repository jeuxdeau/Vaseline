...
const IntroPage = () => {
  return (
    <div>
        ...
        <p/>‘바셀린’은 여러분들이 만날 상대방의 신원을 보장하지 않습니다. 그러므로 오프라인에서 만날 약속을 잡았을 때에는 안전을 위해 다음 수칙을 지키기를 권장합니다.

        <p/>.1. 첫 만남은 카페와 같이 공개된 장소에서! <br/>
        2. 가까운 사람에게 어디로 가는지 미리 알리세요! <br/>
        3. 만남을 빌미로 반려견과 관계 없는 제안(종교, 상품 판매 등)을 하는 사람들을 주의하세요! <br/><br/>
	4. 교배 전에 반려견끼리 충분한 만남을 가지세요!
	5. ???
