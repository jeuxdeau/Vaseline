...
const ProcUserProfileUpdateInfo = (input) => (
	...
	const ProcUserInfo = (input) => ({
		...
		"companion": {
			...
			"desired_mate": {
				"personality": {
					"affinity_with_human": input.companion.desired_mate.personality.affinity_with_human,
					"affinity_with_dog": input.companion.desired_mate.personality.affinity_with_dog,
					"shyness": input.companion.desired_mate.personality.shyness,
					"activity": input.companion.desired_mate.personality.activity,
					"loudness": input.companion.desired_mate.personality.loudness,
					"aggression": input.companion.desired_mate.personality.aggression,
					"etc": input.companion.desired_mate.personality.etc
				},
